...
const closeProfileEditBtn = document.querySelector("#profile-close-btn");
...
const profileEditForm = profileEditModal.querySelector(".modal__form"); //editProfileModal with id of #edit-modal
